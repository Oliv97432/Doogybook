...
-- Version MULTIPLE ALBUMS : Permet de créer plusieurs albums par chien
...
CREATE TABLE IF NOT EXISTS dog_albums (
  ...
  album_title VARCHAR(100) NOT NULL DEFAULT 'Mon Album',
  album_data JSONB NOT NULL,
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW()

  -- PAS de contrainte UNIQUE(dog_id) pour permettre plusieurs albums par chien
);
