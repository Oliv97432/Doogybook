        ...
        <div className="bg-card border border-border rounded-2xl p-6 mb-6">
          <div className="flex items-start gap-6">
            ...
            {avatarUrl ? (
              ...
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-3xl border-4 border-border">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                {isOwnProfile ? (
                  <button
                    ...
                    className="px-4 py-2 border border-border rounded-xl hover:bg-muted transition-smooth flex items-center gap-2"
                  >
                    <Edit size={16} />
                    Modifier le profil
                  </button>
        ...
        <div className="bg-card border border-border rounded-2xl mb-6">
          <div className="flex border-b border-border">
            <button
              ...
              className={`flex-1 px-4 py-3 font-medium transition-smooth ${
                activeTab === 'posts'
                ...
                {dogs.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {dogs.map((dog) => {
                      ...
                      return (
                        <div key={dog.id} className="bg-muted rounded-xl p-4 flex items-start gap-4">
                          {dogPhoto ? (
                            <img
                              src={dogPhoto}
                              alt={dog.name}
                            ...
                            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-orange-400 to-pink-600 flex items-center justify-center text-white font-bold text-2xl">
